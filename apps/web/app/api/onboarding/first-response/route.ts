...
export async function POST() {
  ...
  try {
    ...
    const { text } = await generateText({
      ...
      system: `Ты — AI карьерный консультант платформы VibeOffer. Твоя задача — прочитать CV кандидата и дать персональный первый совет + одну конкретную задачу на эту неделю. Опирайся ТОЛЬКО на факты из CV ниже. Пиши на "вы", по-русски, в markdown, не больше 200 слов.`,

...
const SECURITY_POINTS = [
  ...
  {
    Icon: Info,
    text: 'Если на аккаунте включён 2FA через SMS — войдите с устройства, где hh.ru уже залогинен (бэкенд переиспользует cookies).',
  },
  {
    Icon: AlertTriangle,
    text: 'Используйте отдельный аккаунт для рабочего поиска. Подключение и хранение учётных данных вы подтверждаете в Оферте.',
  },
] as const

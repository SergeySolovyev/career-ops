      ...
      <div className="space-y-8 text-[14px] leading-[1.7] text-slate-700">
        <section>
          ...
          <p>
            ...
            <strong>ИП Соловьёв Сергей Викторович</strong> (далее — «Оператор»). Полные
            реквизиты — в{' '}
        ...
        <section>
          ...
          <ul className="ml-5 mt-2 list-disc space-y-1">
            ...
            <li>
              ...
              4 цифры) и идентификатор транзакции у Tinkoff Касса. Полный номер карты
              и CVV никогда не передаются Оператору — обрабатываются на стороне Tinkoff
        ...
        <section>
          ...
          <ul className="ml-5 mt-2 list-disc space-y-1">
            ...
            <li>
              <strong>АО «Тинькофф Банк»:</strong> для проведения платежа — email,
